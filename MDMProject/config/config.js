module.exports = {
	...
	route_info: [
		...
		{file : './active_onoff', path : '/process/deviceonoff', method: 'device_onoff', type: 'post'},
		{file : './active_onoff', path : '/process/arduinoonoff', method: 'arduino_onoff', type: 'post'},
		...
		{file : './app_initialize', path : '/process/appinitialize', method: 'app_initialize', type: 'post'},
